...
Based on the existing RGRTA proposal materials, the firm's core service strengths can also be described as:
...
## 5.4 Current and Former Clients
...
## 5.5 Healthcare Experience and Relevance

Although the source proposal materials in this workspace were developed for a transit-security procurement, many of the firm-level operating details and capabilities described there are directly relevant to WMCHealth's healthcare environment. The usable details from the RGRTA materials include the firm's emphasis on:
...
## 5.6 Principals and Proposed Leadership
