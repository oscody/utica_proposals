# Scope of Services — Compliance Gap Analysis
# WFA0FE5 — WMCHealth Security Guard Services Proposal

---

## Fully Addressed — No Changes Needed

The following requirements are well-covered across the current draft files:

- 24/7 security operations/control center staffing
- CCTV, alarm, and radio monitoring
- Behavioral health area assignments
- Patient screening and property safeguarding
- Visitor screening and weapons detection screening
- Assisting clinicians with patient restraint
- Escort and transportation support for staff
- Courier and shuttle services (GSH, BSCH, SACH)
- Vehicle patrol, transport, and shuttle responsibilities
- WMCHealth-approved de-escalation training (CPP, 16hr initial + 8hr annual refresher)
- Mandatory WMCHealth training (8hr orientation, CPR, AED within 60 days)
- Uniforms at no cost to WMCHealth or officers
- 4x4 vehicles at no cost (2 Valhalla, 1 MHRH, 1 HAHV)
- Officer equipment (cell phones, tablets) at no cost
- Active shooter and panic alarm response (training)
- Workplace violence response and investigation (training)
- Use of force and restraint support (training)
- Fire emergency response (training)
- Training records, state licenses, and certification tracking
...
## Fee Proposal
The fee proposal is a separate pending item and is not part of this gap remediation. Pricing requires:
- NYS Prevailing Wage schedule lookup (Westchester County) for Valhalla and MHRH
- Internal fully-burdened rate build-up for BSCHS, GSH, SACH
- Insurance quotes for all required coverages
- Vehicle, uniform, weapons/ammo, and training cost amortization

---

## Draft Files Referenced
- `draft/03 Transmittal Letter`
- `draft/04 Executive Summary`
- `draft/06 Experience and References`
- `draft/07 Staffing Proposal`
- `draft/08 Additional Information`
- `draft/10 Fee Proposal Placeholder`
